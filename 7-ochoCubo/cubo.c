...
void moverCubo(){
    ...
    if (atras){
     poscubo[2]=poscubo[2]-paso;
     if(poscubo[2]==delante){	
	bajar=1;
        atras=0;
     }
}
    if(subir){
    poscubo[1]=poscubo[1]+paso;
     if(poscubo[1]==poscuerpo[0][1]){	
	subir=0;
        atras=1;
     }
    }
...
void display()
{
    ...
    /*tronco*/
    glLoadIdentity();
    glTranslatef((GLfloat)poscuerpo[0][0],(GLfloat)poscuerpo[0][1],(GLfloat) poscuerpo[0][2]);
    glutSolidTorus(0.5f,3.0f,15,30);
    glLoadIdentity();
    glTranslatef((GLfloat)poscuerpo[1][0],(GLfloat)poscuerpo[1][1],(GLfloat) poscuerpo[1][2]);
    glutSolidTorus(0.5f,3.0f,15,30);
    glLoadIdentity();
    glTranslatef((GLfloat)poscubo[0],(GLfloat)poscubo[1], (GLfloat)poscubo[2]);
    glutSolidCube(1.0f);
//    glPushMatrix();
//    glPushMatrix();
